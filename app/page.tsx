      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div>
          ...
          <p>
            ...
            まー、コーヒー嫌いのでC.C.Lemon、C.C.Lemonを買えるための寄付でも送っていいぞ(笑)こちらに💁
            7ZwGzoPeP3N5XuKW3b2Y3Aj2zQ6Be5kyjzoDzASgo9s3
        ...
        <div>
          <section id="section1" className="w-full max-w-6xl">
            ...
            <div>
              ...
              大きいマーケットキャップのコインもあるし、低いのもありますので色んなプレイができます。ただただ
              memecoin じゃないのでご安心。
              ...
              せめてLPぐらいを知った方が良いね。 オッケーこれで準備できました。
              さてと、ゲームの説明に入ります。
            </div>
          </section>
          さてと、ゲームの説明に入ります。
          ...
          <section id="section5" className="w-full max-w-6xl">
            ...
            <div>
              ...
              ツイッターでコンテントを作ったり、僕みたい一つのコミュニティー宛に何かを作ったりとか、Bootcamp生放送のMeteoraの使い方をしたりとか、M3M3と言うMeteoraのパートナーシップのおかげでできる事とか、いろんな事ができます。
              それをできたら、役をもらい、新たなメンバーを手伝って、コミュニティーを最高にしましょう。
              結構Meteoraって深い道具なので、色んな先生と言える方もいるし、色んなガイド、チュートリアル、動画などがネットに流れてます。
